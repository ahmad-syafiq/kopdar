...
$Bbc->home			= 'dashboard.main';			// ini adalah halaman pertama atau bisa di bilang indexnya
$Bbc->home_user	= 'dashboard.main';			// ini adalah halaman pertama untuk user yang login
